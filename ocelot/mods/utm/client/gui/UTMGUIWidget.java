...
public class UTMGUIWidget extends Gui
{
	...
	public UTMGUIWidget(int x, int y, int width, int height)
	{
	...
	{
		if (actionCommand != null && screen instanceof IGUIActionListener) ((IGUIActionListener) screen).actionPerformed(actionCommand, params);
	}
