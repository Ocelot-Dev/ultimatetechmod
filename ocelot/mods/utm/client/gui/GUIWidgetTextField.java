...
public class GUIWidgetTextField extends UTMGUIWidget
{
	private String	text;
	...
	public GUIWidgetTextField(int x, int y, int width, int height, String text)
	{
	...
	public GUIWidgetTextField setActionCommand(String s)
	{
		actionCommand = s;
		return this;
	}
	...
	public GUIWidgetTextField setMaxStringLength(int i)
	{
		maxStringLength = i;
		return this;
	}

	public GUIWidgetTextField setAllowedCharacters(String s)
	{
		if (s == null)
